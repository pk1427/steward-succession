...
Readers start from the stable root feed owner/topic in `config/public-identities.json`. Its council-held authority points to the active publisher feed; rotating publisher identities therefore does not change the public reader address.
